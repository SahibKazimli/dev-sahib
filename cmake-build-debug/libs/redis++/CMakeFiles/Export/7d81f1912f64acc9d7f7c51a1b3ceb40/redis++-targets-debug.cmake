...
set_target_properties(redis++::redis++ PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libredis++.1.3.15.dylib"
  IMPORTED_SONAME_DEBUG "@rpath/libredis++.1.dylib"
  )

list(APPEND _cmake_import_check_targets redis++::redis++ )
list(APPEND _cmake_import_check_files_for_redis++::redis++ "${_IMPORT_PREFIX}/lib/libredis++.1.3.15.dylib" )
